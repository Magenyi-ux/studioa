...
/**
 * @fileOverview Summarizes notes using an AI assistant.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following notes for a student to quickly review key concepts:\n\n{{{notes}}}`, // Corrected: Handlebars syntax for accessing 'notes'
});
